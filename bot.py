...
test_date = "01/05/23"
post_code = "PO30"
test_centre_names = ["Newport (Isle of Wight)", "Lee On The Solent", "Portsmouth"]
user_title = "Mr"
first_names = "Bob"
surname = "Banton"
...
with Fragile(Chrome(options=options, version_main=111)) as driver:
    ...
    watcher.start()
    time.sleep(delay)  # Wait for sub-thread to check page
    ...
    on_modal_screen = execute_with_retry(
        retries, is_el_found_by_attribute, "underlay-wrapper", "5.50", By.CLASS_NAME, driver, 25, 2.5)
    ...
    step_seven_first_name_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "firstName", "6.21.0", By.NAME, driver)

    execute_with_retry(retries, click_el_else_quit, "First Names Input", step_seven_first_name_form, "6.21.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit,
        "First Names Input", step_seven_first_name_form, first_names, "6.21.2", driver)
    time.sleep(delay)

    step_seven_surname_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "surname", "6.22.0", By.NAME, driver)

    execute_with_retry(retries, click_el_else_quit, "Surname Input", step_seven_surname_form, "6.22.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit, "Surname Input", step_seven_surname_form, surname, "6.22.2", driver)
    time.sleep(delay)

    step_seven_address_line_1_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "addressLine1", "6.23.0", By.NAME, driver)

    execute_with_retry(
        retries, click_el_else_quit, "Address Line 1 Input", step_seven_address_line_1_form, "6.23.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit,
        "Address Line 1 Input", step_seven_address_line_1_form, address_line_1, "6.23.2", driver)
    time.sleep(delay)

    step_seven_town_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "town", "6.24.0", By.NAME, driver)

    execute_with_retry(retries, click_el_else_quit, "Town Input", step_seven_town_form, "6.24.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit, "Town Input", step_seven_town_form, town, "6.24.2", driver)
    time.sleep(delay)

    step_seven_postcode_full_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "postcode", "6.25.0", By.NAME, driver)

    execute_with_retry(
        retries, click_el_else_quit, "Postcode Full Input", step_seven_postcode_full_form, "6.25.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit,
        "Postcode Full Input", step_seven_postcode_full_form, post_code_full, "6.25.2", driver)
    time.sleep(delay)

    step_seven_email_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "emailAddress", "6.26.0", By.NAME, driver)

    execute_with_retry(retries, click_el_else_quit, "Email Input", step_seven_email_form, "6.26.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit, "Email Input", step_seven_email_form, email, "6.26.2", driver)
    time.sleep(delay)

    step_seven_confirm_email_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "confirmEmailAddress", "6.27.0", By.NAME, driver)

    execute_with_retry(
        retries, click_el_else_quit, "Confirm Email Input", step_seven_confirm_email_form, "6.27.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit,
        "Confirm Email Input", step_seven_confirm_email_form, email, "6.27.2", driver)
    time.sleep(delay)

    step_seven_contact_number_form = execute_with_retry(
        retries, get_el_by_attribute_else_quit, "contactNumber", "6.28.0", By.NAME, driver)

    execute_with_retry(
        retries, click_el_else_quit, "Contact Number Input", step_seven_contact_number_form, "6.28.1", driver)
    time.sleep(delay)

    execute_with_retry(
        retries, fill_text_input_else_quit,
        "Contact Number Input", step_seven_contact_number_form, contact_number, "6.28.2", driver)
    time.sleep(delay)
